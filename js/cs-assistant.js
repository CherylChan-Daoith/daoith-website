...
(function () {
  ...
  const SERVICE_INDEX = [
    ...
    { id: 'domestic-diagnosis', title: '财税合规方案定制', en: 'Custom tax compliance plan', keys: '人工诊断 合规评估 诊断报告 体检 方案定制 跨境电商' },
    { id: 'consult-annual', title: '财税合规陪跑', en: 'Compliance coaching', keys: '陪跑 全年 顾问年 合规陪跑' },
    { id: 'consult-year-advisor', title: '常年财税顾问', en: 'Year-round tax advisory', keys: '常年顾问 常年财税 顾问基础版 顾问VIP 税检应对 政策解读' },
    ...
    { id: 'domestic-rebate-first', title: '首单退税辅导', en: 'First-time rebate coaching', keys: '首单退税 核查 一般贸易 0110' },
    { id: 'domestic-rebate-1210-9610', title: '1210/9610出口退税首单陪跑服务', en: '1210/9610 first-time rebate coaching', keys: '1210 9610 保税 零售出口 清单 首单陪跑' },
    { id: 'domestic-rebate-9810', title: '9810出口退税首单陪跑服务', en: '9810 first-time rebate coaching', keys: '9810 海外仓 离境即退税 首单陪跑' },
  ...
  const COPY = {
    zh: {
      ...
      goAi: '打开 AI合规助手',
      taxRedirect:
        '合规细节请交给「AI解决方案」或预约专家，我这边不深入解答税务法规。点击下方即可生成专属合规方案。',
      ...
      goHub: '打开服务管理',
      greet: '你好，想先体验 AI 解决方案、找一项服务，还是提交询价／查进度？',
      fallback: '我可以帮你：体验 AI 解决方案、推荐服务、提交询价，或查询服务进度。请选一项，或简单说说国家、平台和需求。',
      busy: '正在回复…',
    ...
    en: {
      ...
      greet: 'Hi — would you like AI Solutions, a service recommendation, an inquiry, or a progress check?',
      fallback: 'I can help with AI Solutions, service recommendations, inquiries, or progress. Pick one, or tell me country, platform and need.',
      busy: 'Replying…',
