...
window.DAOITH_SERVICES = [
    ...
    /* ——— 中国内地财税合规 ——— */
  {
    ...
    },
    {
      ...
      category: 'mainland',
      title: '公司注册与资质办理',
      desc: '中国大陆公司设立全流程：核名、材料、提交审核、领照及开户刻章等后续事项；可衔接进出口资质',
      priceLabel: '¥5,000',
      priceValue: 5000,
      unit: '/起',
      details: blocks({
        content:
          '按中国大陆公司注册标准流程交付：前期确定公司基本信息 → 名称申报 → 材料准备 → 提交申请与审核 → 核准发照 → 开户／刻章／税务与社保衔接；跨境卖家可按需加办进出口权、海关备案、电子口岸等资质。',
        bullets: [
          '前期准备：经营范围、人员架构、注册资本与出资、公司名称',
          '名称申报与核名通过确认',
          '申请材料齐套（住所、股东身份、章程、申请书等）',
          '线上／窗口提交与补正跟进',
          '核准发照与电子／纸质执照交接',
          '后续：刻章、银行开户、税务与社保公积金登记辅导',
          '可选：进出口权／海关备案／电子口岸',
        ],
        pricing:
          '¥5,000／起（含工商设立辅导与约定范围内后续事项）。政府规费、刻章、银行开户、加急及异地办理、进出口等资质另计；最终以方案报价为准。',
        process: [
          '前期准备：确定经营范围、人员、注册资本与公司名称',
          '名称申报（核名不通过则修改重报）',
          '准备设立申请材料',
          '提交设立申请（线上或窗口）',
          '市场监管局审核与补正跟进',
        ...
        steps: [
          ...
          {
            title: '名称申报（核名通过后进入下一步）',
            time: '通常 1–3 个工作日；不通过则改名重报',
          },
          {
            title: '准备申请材料（住所、股东、人员、章程等）',
            time: '材料收集约 2–7 个工作日',
          },
          {
            title: '提交设立申请（线上／窗口）',
          ...
          {
            title: '后续事项：刻章、开户、税务与社保公积金',
            time: '领照后 3–10 个工作日（视银行预约）',
          },
          {
            title: '可选：进出口权／海关备案／电子口岸',
            time: '主体齐备后约 5–15 个工作日',
          },
        ],
        timeline:
          '普通设立常见约 5–15 个工作日（视核名与材料齐套）；含开户刻章约再加 3–10 个工作日；含进出口资质通常合计 10–25 个工作日（视地方窗口）。',
        faqs: [
          {
            q: '名称申报不通过怎么办？',
            a: '按市场监管反馈调整字号／行业表述后重新申报；建议一次性准备 3–5 个备选名称以缩短周期。',
          },
          {
            q: '个人能否直接办进出口权？',
            a: '进出口权通常挂靠企业主体。个人店铺模式与公司模式义务不同，建议先做主体规划咨询。',
          },
          {
            q: '外资或特殊主体能否全程网办？',
            a: '部分情形须线下窗口递交纸质材料；我们会按当地市场监管要求选择线上或线下路径并辅导材料形式。',
          },
        ],
      }),
    },
