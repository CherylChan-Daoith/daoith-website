...
希望定期做财税健康筛查、并在税检时获得专业应对支持的企业`,
        conditions: ``,
        pricingTable: {
          headers: ["服务项目", "服务内容介绍", "基础版", "VIP版"],
          rows: [
            ["服务收费", "按年签约", "29,800 元/年", "49,800 元/年"],
            [
              "经营事项涉税咨询\n全方位、伴随式咨询支持",
              "日常经营涉税咨询：解答开票、收票、费用报销、增值税/企业所得税申报、税收优惠申请等高频问题\n重大合同涉税条款审核：对采购、销售、资产转让、租赁等重大合同做涉税条款事前审核\n新业务模式税务评估：对新业务/新模式做税务定性、适用税率及合规要求前置分析",
              "✓",
              "✓",
            ],
            [
              "税务检查应对\n专业化的危机处理",
              "面临税务检查时提供专业指导与策略建议\n协助审阅《税务事项通知书》《税务处理决定书》等文书并分析合法性与合理性\n对检查结论有异议时，协助起草说明材料并指导合理陈述与申辩",
              "✓",
              "✓",
            ],
            [
              "最新税收政策解读\n及时性、实用性的政策导航",
              "推送与企业相关的最新税收政策并提炼核心要点\n深度解读政策背景，评估对企业的机遇或挑战\n将复杂法规转化为可执行操作步骤，辅导财务人员准确落地",
              "✓",
              "✓",
            ],
            [
              "面对面深度沟通\n定制化、精准化的专业互动",
              "组织专家团队与企业召开专项会议，针对复杂财税问题（如新业务拓展、资产损失、特殊税务事项等）研讨并制定方案",
              "1 次/年",
              "2 次/年",
            ],
            [
              "财税风险全面筛查\n系统性、预防性的健康体检",
              "运用 AI 与大数据出具财税健康体检报告；识别发票、供应商、客户、税负等潜在风险；书面列明风险点、等级、依据与整改建议",
              "1 次/年",
              "2 次/年",
            ],
          ],
