...
4个月内 100,000
6个月内 150,000`,
        pricingNote: `2个月内60000元、4个月内100000元、6个月内150000元，按陪跑周期分档计价；含调研诊断、周期规划、流程与工具搭建、系统部署、团队带教与验收；第三方软件/账号费用及超出约定范围的定制开发另计；可按里程碑分期支付。`,
...
配合完成零申报处理`,
        ...
        pricing: `按营业额分级：
无运营 2,200元/年
(≤200万港币) 普通≤3,200/电商≤4,800
(≤600万港币) 普通≤4,000/电商≤6,000；
(≤1000万港币) 普通≤4,800/电商≤7,200；
(≤2000万港币) 普通≤6,600/电商≤10,000；
(≤4000万港币) 普通≤8,500/电商≤13,000；
(≤6000万港币) 普通≤9,800/电商≤14,800；
(≤8000万港币) 普通≤11,600/电商≤17,800；
(≤1亿港币) 普通≤13,600/电商≤20,500；
(≤1.5亿港币) 普通≤16,600/电商≤25,000；
(≤2亿港币) 普通≤20,600/电商≤31,000；
历史补审 按实际报价。`,
...
提供后续收付汇、结汇、账户日常维护及避免账户冻结的基本指引`,
        ...
        pricing: `香港公司银行开户（需关联公司）汇丰银行/恒生银行¥5,000 
香港公司银行开户（需关联公司）— 香港星展银行¥8,000 
香港公司银行开户（需关联公司）— 香港花旗银行(转账无限额）¥10,000 
香港公司银行开户（无需关联公司·建行亚洲）¥6,000`,
...
整理全套变更后文件交付客户，并提供文件归档与后续银行/业务更新提示`,
        ...
        pricing: `公司名称变更1,800元（含税）
变更董事及股权1,200元（含税）
变更公司秘书和注册地址800元（含税）
增加注册股本1,200元（含税）`,
        pricingNote: `变更公司名称1800元/项，含全套（最新注册证书、商业登记证、公司章程、会议记录本、钢印、签名章、小圆章）；政府规费（注册处、税务局牌费等）另计，实报实销；加急办理另行报价。`,
