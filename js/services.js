...
计划用 AI 降本增效的跨境电商及贸易企业`,
    ...
    },
    {
      ...
      details: excelBlocks({
        ...
        process: ``,
        pricing: `48,000 元/次（含基础申报代理与材料撰写；专项审计、知识产权申请等第三方费用另计，实报实销；未通过可按合同约定免费复核或续办）`,
        pricingNote: ``,
        advantages: ``,
...
计划申报政府奖补、投标加分的成长型企业`,
    ...
    },
    {
      ...
      details: excelBlocks({
        ...
        process: ``,
        pricing: `25,000 元/次（含材料整理与申报代理；检测费、软著登记费等第三方费用另计；软件企业与软件产品登记可打包报价）`,
        pricingNote: ``,
        advantages: ``,
...
需办理软件产品登记、双软评估的 IT 与信息服务企业`,
    ...
    },
    {
      ...
      details: excelBlocks({
        ...
        process: ``,
        pricing: `20,000 元/次（含材料撰写与申报代理；专项审计等第三方费用另计，实报实销）`,
        pricingNote: ``,
        advantages: ``,
...
需设立区域或采购主体的跨境电商及供应链企业`,
    ...
    },
    {
      ...
      category: 'other',
      title: `迪拜公司设立`,
      desc: `选址设区 + 秘书地址 + 政府官费 · 合规落地。`,
      priceLabel: `¥46,000`,
      priceValue: 46000,
      unit: ``,
      details: excelBlocks({
        content: `自由区/本土（Mainland）架构设计、签证名额与牌照类型评估、名称预留与业务活动核定、向自由区管理局/经济部门递交设立审批、公司秘书与注册地址、营业执照及全套公司文件交付、后续做账报税/年审/签证/开户衔接。`,
        cycle: `整体约 3–4 周（不含银行开户）`,
        processSteps: [{ title: `架构与选址确认`, time: `1 周` }, { title: `名称与活动核定`, time: `3–5 个工作日` }, { title: `材料准备`, time: `1 周` }, { title: `递交审批`, time: `自由区约 1–2 周` }, { title: `执照签发`, time: `审批通过后` }, { title: `文件交付`, time: `整体约 3–4 周` }],
        process: ``,
        pricing: `46,000 元（含公司注册地址 + 政府官费约 2.6 万；不含银行开户，办理开户需公司卡 + 签证名额）`,
        pricingNote: ``,
        advantages: ``,
        audience: ``,
        conditions: ``,
    ...
    },
    {
      ...
      category: 'other',
      title: `迪拜公司做账报税`,
      desc: `按国际财务报告准则记账、财务报表出具、阿联酋联邦企业所得税登记与申报。`,
      priceLabel: `¥10,000`,
      priceValue: 10000,
      unit: `起`,
      details: excelBlocks({
        content: `按国际财务报告准则记账、财务报表出具、阿联酋联邦企业所得税登记与申报。`,
        cycle: `按财年周期持续服务（月度记账 + 年度企税申报）`,
        processSteps: [{ title: `资料收集`, time: `按月/季` }, { title: `日常记账`, time: `按月完成` }, { title: `财务报表编制`, time: `财年结束后 1–2 个月` }, { title: `税务计算与申报`, time: `企税：财年结束后 9 个月内` }, { title: `税款缴纳`, time: `按税局缴税通知` }],
        process: ``,
        pricing: `10,000 元起（按交易量与复杂度报价；VAT 注册费、审计费等实报实销）`,
        pricingNote: ``,
        advantages: ``,
        audience: ``,
        conditions: ``,
    ...
    },
    {
      ...
      category: 'other',
      title: `迪拜公司审计`,
      desc: `审计目的与范围确认（银行开户/年审/融资/集团合并）、持牌审计师审计实施、按适用准则出具审计报告与管理建议书。`,
      priceLabel: `¥10,000`,
      priceValue: 10000,
      unit: `起`,
      details: excelBlocks({
        content: `审计目的与范围确认（银行开户/年审/融资/集团合并）、持牌审计师审计实施、按适用准则出具审计报告与管理建议书。`,
        cycle: `整体约 5–8 周`,
        processSteps: [{ title: `审计需求确认`, time: `3–5 个工作日` }, { title: `资料收集`, time: `1–2 周` }, { title: `审计程序执行`, time: `2–3 周` }, { title: `审计报告出具`, time: `1–2 周` }],
        process: ``,
        pricing: `10,000 元起（含理账与审计服务费；政府规费另计）`,
        pricingNote: ``,
        advantages: ``,
        audience: ``,
        conditions: ``,
