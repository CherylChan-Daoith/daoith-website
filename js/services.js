...
• 降低核查风险：帮助企业建立规范的出口退税单证体系，顺利通过首次核查`,
    ...
    },
    {
      ...
      desc: `面向跨境电商零售出口（9610）及保税电商（1210）企业的首单退税陪跑：梳理清单/报关单、物流与销售证据链，辅导首次退（免）税申报顺利通过核查。`,
      priceLabel: `¥10,000`,
      priceValue: 10000,
      unit: `/次`,
      details: excelBlocks({
        content: `一、监管方式与退税路径评估
• 确认企业出口业务适用1210（保税电商）或9610（跨境电商零售出口）监管方式
• 评估清单核放、汇总申报、分送集报等通关形态对退（免）税资料的影响
• 梳理进出口主体、物流服务商、平台订单与收汇路径是否匹配
• 对不满足退税条件的情形，给出整改建议或改走免税沟通要点
二、资质与备案审核
• 审核一般纳税人身份、海关备案、电子口岸、出口退（免）税备案及退税账户
• 核对经营范围、纳税人资质与跨境电商出口业务类型是否匹配
三、1210/9610出口单证辅导
• 辅导准备并核对报关清单/报关单、汇总逻辑与HS编码申报要求
• 指导留存平台订单、物流轨迹、入出仓/集货仓记录等证据链
• 审核出口合同/销售说明、运费单据、收汇凭证的一致性
• 指导与物流商、平台、境外买家/消费者的沟通记录归档
四、外购与进项资料辅导
• 审核采购合同、进项发票、付款凭证及运输单据的完整性与勾稽关系
五、首次核查与申报陪跑
• 协助填写首次申报核查相关材料及业务情况说明
• 指导增值税、企业所得税、印花税等税务自查
• 资料整合交付，并陪跑完成首单退（免）税代理申报`,
        process: `需求沟通→监管方式与路径评估→资质备案审核→清单/报关单与证据链梳理→外购进项辅导→核查材料准备→税务自查→资料交付→首单退税申报陪跑。`,
        pricing: `1210/9610出口退税首单陪跑（全套） ¥10,000`,
        pricingNote: `服务有效期一年，含路径评估、资质审核、1210/9610单证与证据链辅导、核查材料准备、税务自查、资料整合及首单退税申报陪跑；物流改造另行委托、多年度补审、账务混乱需额外整理、多次更换单证等复杂情况费用另行协商。`,
        advantages: `• 针对1210/9610专项：贴合跨境电商零售与保税电商的清单/报关实务，不照搬一般贸易模板
• 证据链闭环：平台订单、物流、入出仓与收汇一并梳理，降低首次核查补件风险
• 路径前置判断：先评估能否退税、是否宜与税局沟通免税，避免无效申报
• 全流程陪跑：从评估、备件到首单申报，一站式落地`,
        audience: `已采用或计划采用1210/9610出口的跨境电商卖家；需凭清单/报关单首次申请退（免）税的企业；SHEIN外综服、速卖通等涉及9610清单的商家；保税仓一件代发、一日游等1210场景企业。`,
        pricingTable: null,
        bundle: null,
      }),
    },
    {
      ...
      desc: `面向跨境电商出口海外仓（9810）企业的首单退税陪跑：对接「离境即退税、销售再核算」要求，梳理报关、销售佐证与收汇资料，协助首次退（免）税申报落地。`,
      priceLabel: `¥10,000`,
      priceValue: 10000,
      unit: `/次`,
      details: excelBlocks({
        content: `一、9810退税路径与政策适用评估
• 确认企业出口业务适用海关监管方式9810（出口海外仓）
• 讲解并评估「离境即退税、销售再核算」与已销售按现行规定申报的适用场景
• 梳理出口主体、海外仓、平台销售与收汇路径是否匹配
• 提示实操中税局对销售清单、收汇证明的审核要点，提前与主管税局沟通准备
二、资质与备案审核
• 审核一般纳税人身份、海关备案、电子口岸、出口退（免）税备案及退税账户
• 核对经营范围、纳税人资质与海外仓出口业务类型是否匹配
三、9810出口与销售佐证辅导
• 审核报关单完整性、准确性及与海外仓入仓记录的对应关系
• 指导整理境外销售清单、平台成交数据与会计收入确认口径
• 辅导预退税（如适用）申报类型填写及后续销售核算资料留存要求
• 审核收汇凭证、运费单据、仓储单据等配套材料一致性
四、外购与进项资料辅导
• 审核采购合同、进项发票、付款凭证及运输单据的完整性与勾稽关系
五、首次核查与申报陪跑
• 协助准备首次申报核查材料及业务情况说明
• 指导增值税、企业所得税、印花税等税务自查
• 资料整合交付，并陪跑完成首单退（免）税代理申报`,
        process: `需求沟通→9810路径与税局口径评估→资质备案审核→报关与销售佐证梳理→外购进项辅导→核查材料准备→税务自查→资料交付→首单退税申报陪跑。`,
        pricing: `9810出口退税首单陪跑（全套） ¥10,000`,
        pricingNote: `服务有效期一年，含9810路径评估、资质审核、报关与销售佐证辅导、核查材料准备、税务自查、资料整合及首单退税申报陪跑；多年度补审、账务混乱需额外整理、多次更换单证、税局不受理9810退税需改架构等复杂情况费用另行协商。`,
        advantages: `• 贴合9810专项：覆盖海外仓离境退税与销售再核算的资料节奏，避免与0110混用模板
• 销售佐证前置：提前整理境外销售清单与收汇证明，降低首次审核卡点
• 政策落地陪跑：对照现行公告要求辅导申报类型与核算期资料留存
• 全流程闭环：从评估、备件到首单申报一站式落地`,
        audience: `以9810方式出口至海外仓的跨境电商企业；计划首次办理9810出口退（免）税的卖家；已离境报关但销售佐证、收汇资料尚不齐备的企业。`,
        pricingTable: null,
        bundle: null,
      }),
    },
