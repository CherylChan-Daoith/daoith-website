...
(function () {
  ...
  window.DAOITH_SERVICE_CATEGORIES = [
    ...
    { id: 'consult', label: '财税咨询', en: 'Advisory', blurb: '1v1、方案定制、陪跑、常年顾问与资质认定', blurbEn: '1-on-1, custom plans, coaching, year-round advisory and qualifications' },
...
跟踪财税政策变化，及时告知企业可能受到的影响及应对建议`,
        ...
        process: ``,
        pricing: ``,
        pricingNote: `按年签约；各档含约定额度的线下上门、线上沟通与税局应对；超出额度可按次/小时加购。尚未完成诊断者可搭配「财税合规方案定制」先行出方案再进入陪跑。`,
        advantages: ``,
...
缺乏内部合规团队的企业`,
        conditions: ``,
        pricingTable: {
          headers: ["方案", "线下上门", "线上沟通", "税局应对", "价格"],
          rows: [
            ["服务方案 1", "4 次", "20 小时以内", "2 次", "38,000 元/年"],
            ["服务方案 2", "6 次", "30 小时以内", "3 次", "53,000 元/年"],
            ["服务方案 3", "8 次", "40 小时以内", "4 次", "68,000 元/年"],
            ["服务方案 4", "10 次", "不限次数和时间", "5 次", "83,000 元/年"],
            ["服务方案 5", "12 次", "不限次数和时间", "不限次数", "98,000 元/年"],
          ],
        },
        bundle: null,
      }),
    },
    {
      ...
      category: 'consult',
      title: `常年财税顾问`,
      desc: `经营涉税咨询 · 税检应对 · 政策解读 · 面对面沟通 · 风险筛查。`,
      priceLabel: `¥29,800`,
      priceValue: 29800,
      unit: `/年起`,
      details: excelBlocks({
        content: `一、经营事项涉税咨询（全方位、伴随式咨询支持）
日常经营涉税咨询：解答企业开票、收票、费用报销、增值税/企业所得税申报、税收优惠申请等高频日常问题
重大合同涉税条款审核：对企业拟签署的重大合同（采购、销售、资产转让、租赁等）进行涉税条款事前审核，规避潜在税务陷阱与纠纷
新业务模式税务评估：对企业拟开展的新业务/新模式（如线上销售、跨境业务等）进行税务定性、适用税率及合规要求的前置分析
二、税务检查应对（专业化的危机处理）
企业面临税务检查时，提供专业指导与策略建议，保障企业合法权益
协助企业审阅《税务事项通知书》《税务处理决定书》等文书，分析其合法性与合理性
对检查结论有异议时，协助起草向税局的说明材料，指导企业合理陈述与申辩
三、最新税收政策解读（及时性、实用性的政策导航）
推送与企业相关的最新税收政策，提炼核心要点
深度解读政策背景，评估对企业的具体影响（机遇或挑战）
将复杂法规转化为清晰的操作步骤与指引，辅导财务人员准确执行
四、面对面深度沟通（定制化、精准化的专业互动）
组织专家团队与企业人员召开专项会议，针对特定复杂财税问题（如新业务拓展涉税处理、资产损失处理、特殊税务事项等）进行研究、讨论并制定解决方案
五、财税风险全面筛查（系统性、预防性的健康体检）
运用 AI 与大数据能力出具财税健康体检报告；识别发票、供应商、客户、税负等潜在风险；提供书面报告，列明风险点、风险等级、法规依据与整改建议`,
        cycle: `服务开启后 1 年（按年签约）`,
        processSteps: [
          { title: `企业情况对接`, time: `1 周内` },
          { title: `日常咨询响应`, time: `全年持续` },
          { title: `政策推送与解读`, time: `按政策更新` },
          { title: `面对面深度沟通`, time: `按档安排` },
          { title: `财税风险筛查`, time: `按档安排` },
          { title: `税检事项应对`, time: `触发时响应` },
          { title: `年度复盘`, time: `服务期末` },
        ],
        process: ``,
        pricing: ``,
        pricingNote: `按年签约；基础版与 VIP 版均含经营涉税咨询、税务检查应对与最新政策解读；面对面深度沟通与财税风险筛查按档提供。`,
        advantages: ``,
        audience: `需要全年伴随式财税咨询支持的企业
日常开票申报、合同审核与新业务税务评估频发的企业
希望定期做财税健康筛查、并在税检时获得专业应对支持的企业`,
        conditions: ``,
        pricingTable: {
          variant: 'pricing-tiers',
          headers: ["服务项目", "基础版", "VIP版"],
          rows: [
            ["服务收费", "29,800 元/年", "49,800 元/年"],
            ["经营事项涉税咨询\n全方位、伴随式咨询支持", "✓", "✓"],
            ["税务检查应对\n专业化的危机处理", "✓", "✓"],
            ["最新税收政策解读\n及时性、实用性的政策导航", "✓", "✓"],
            ["面对面深度沟通\n定制化、精准化的专业互动", "1 次/年", "2 次/年"],
            ["财税风险全面筛查\n系统性、预防性的健康体检", "1 次/年", "2 次/年"],
          ],
        },
        bundle: null,
      }),
