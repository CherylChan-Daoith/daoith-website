...
window.DAOITH_I18N_EN = {
  ...
  selectors: {
    ...
    '#heroPanel0 .hero-panel-copy h2': { text: 'Expert-informed AI diagnosis' },
    '#heroPanel0 .hero-panel-copy > p': {
      text: 'Answer step-by-step on platform, entity, shipping and invoices — get an actionable compliance plan in minutes for the most common seller scenarios.',
    },
    ...
    '#heroPanel1 .hero-panel-copy h2': { text: 'Senior cross-border tax experts, 1:1' },
    '#heroPanel1 .hero-panel-copy > p': {
      text: 'Human review of complex structures, rebate paths and tax risks — with clear recommendations and an action list.',
    },
    '#heroPanel1 .hero-panel-points li:nth-child(1)': { text: 'Ex-Big Four senior experts' },
    '#heroPanel1 .hero-panel-points li:nth-child(2)': { text: 'In-person sessions in Shenzhen' },
    ...
    '#heroPanel2 .hero-panel-copy > p': {
      text: 'From bookkeeping and export rebates to Hong Kong company services and bundles — 15 products with clear pricing; add to inquiry for a tailored quote.',
    },
    '#heroPanel2 .hero-panel-points li:nth-child(1)': { text: 'Browse by category' },
    '#heroPanel2 .hero-panel-points li:nth-child(2)': { text: 'Dedicated product pages' },
    '#heroPanel2 .hero-panel-points li:nth-child(3)': { text: 'Modular bundle options' },
    '#heroPanel2 .btn-primary': { text: 'Browse Services' },
    '#heroPanel3 .hero-panel-copy h2': { text: 'AI + professional team, end to end' },
    '#heroPanel3 .hero-panel-copy > p': {
      text: 'Inquiries, orders and progress in one place — track milestones, check status, and rely on AI-enabled delivery you can trust.',
    },
    '#heroPanel3 .hero-panel-points li:nth-child(1)': { text: 'Quotes and payments at a glance' },
    '#heroPanel3 .hero-panel-points li:nth-child(2)': { text: 'Milestone-based progress' },
    '#heroPanel3 .hero-panel-points li:nth-child(3)': { text: 'WeChat login to view' },
