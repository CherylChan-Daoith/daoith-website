window.DAOITH_I18N_ZH = {
  ...
  strings: {
    ...
    'alert.platformCountry': '请至少选择电商平台、店铺主体和目的国/地区',
...
window.DAOITH_I18N_EN = {
  ...
  strings: {
    ...
    'alert.platformCountry': 'Please select platform, store entity, and destination country/region',
  ...
  selectors: {
    ...
    '#aiForm .form-group:nth-child(2) label': { text: 'Store entity' },
    '#aiForm .form-group:nth-child(3) label': { text: 'Destination country/region' },
    '#aiForm .form-group:nth-child(4) label': { text: 'HS Code' },
    '#aiForm .form-group:nth-child(5) label': { text: 'Annual revenue (CNY 10k / 万元人民币)' },
    '#aiForm .form-group:nth-child(6) label': { text: 'Team size' },
    '#aiForm .form-group:nth-child(7) label': { text: 'Supplier invoices' },
    '#aiForm .form-group:nth-child(8) label': { text: 'Shipping model' },
    '#aiForm .form-group:nth-child(9) label': { text: 'Additional notes (optional)' },
    '#queryTax': { text: 'Query export rebate rate' },
    ...
    '.tax-form-grid .form-group:nth-child(3) label': { text: 'Store entity' },
    '.tax-form-grid .form-group:nth-child(4) label': { text: 'Applicable income tax rate (%)' },
    '.tax-form-grid .form-group:nth-child(5) label': { text: 'Product cost ratio (%)' },
    '.tax-form-grid .form-group:nth-child(6) label': { text: 'Marketing ratio (%) incl. platform fees' },
    '.tax-form-grid .form-group:nth-child(7) label': { text: 'Logistics ratio (%)' },
    '.tax-form-grid .form-group:nth-child(8) label': { text: 'Staff cost ratio (%)' },
    '.tax-form-grid .form-group:nth-child(9) label': { text: 'Other expense ratio (%)' },
    '.tax-form-grid .form-group:nth-child(10) label': { text: 'Destination import CIF value (CNY 10k)' },
    '.tax-form-grid .form-group:nth-child(11) label': { text: 'Destination duty rate (%)' },
    '.tax-form-grid .form-group:nth-child(12) label': { text: 'Destination VAT rate (%)' },
  ...
  services: [
    { title: 'Expert 1-on-1 advisory', desc: 'In-depth consulting on structure, compliance diagnosis, and rebate optimization.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: '/ hour' },
    { title: 'Compliance coaching (annual)', desc: 'Year-round expert support across structure, accounting, rebates, and overseas tax.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: '/ year' },
    { title: 'Cross-border tax diagnosis', desc: 'Full compliance assessment with remediation report and export rebate review.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: '/ session' },
    { title: 'Bookkeeping & filing', desc: 'Bookkeeping, tax filing, and annual reconciliation for e-commerce businesses.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: '/ month' },
    { title: 'Export rebate agency', desc: 'Full 9810/9610 rebate filing including documentation and authority liaison.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: '/ case' },
    { title: 'Company setup & licenses', desc: 'Company registration, import/export rights, customs filing, and e-port setup.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: ' from' },
    { title: 'EU VAT registration', desc: 'VAT registration and filing in UK, Germany, France, and other EU markets.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: '/ country' },
    { title: 'US sales tax compliance', desc: 'State sales tax registration, filing, and economic nexus advisory.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: '/ state' },
    { title: 'ODI filing agency', desc: 'End-to-end outbound investment filing (NDRC, commerce, SAFE).', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: ' from' },
    { title: 'Offshore company setup', desc: 'Incorporation and secretarial services in HK, Singapore, US, BVI, etc.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: ' from' },
    { title: 'Transfer pricing documentation', desc: 'Local file, master file, and contemporaneous documentation for related-party transactions.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: ' from' },
    { title: 'High-tech enterprise qualification', desc: 'Application support including R&D expense aggregation and IP planning.', detailBtn: 'Service details', cartBtn: 'Add to cart', unit: ' from' },
  ],
  servicesCatalog: [
    {
      id: 'consult-1v1',
