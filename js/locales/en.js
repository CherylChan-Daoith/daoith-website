...
window.DAOITH_I18N_EN = {
  ...
  selectors: {
    ...
    '.tax-form-grid .form-group:nth-child(5) label': { text: 'Applicable income tax rate (%)' },
    '.tax-form-grid .form-group:nth-child(6) label': { text: 'Product cost ratio (%)' },
    '.tax-form-grid .form-group:nth-child(7) label': { text: 'Marketing ratio (%) incl. platform fees' },
