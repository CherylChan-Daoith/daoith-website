...
window.DAOITH_I18N_EN = {
  ...
  strings: {
    ...
    'article.back': '← Back to insights',
    'tax.back': '← Back to regional tax',
    'article.loading': 'Loading…',
    'tax.loading': 'Loading…',
    'article.notFoundTitle': 'Article not found',
    'article.notFoundDesc': 'Please choose an article from the insights list.',
  ...
  selectors: {
    ...
    '.nav a[href="#expert"]': { text: 'Insights' },
    ...
    '#expert .section-header h2': { text: 'Expert Insights' },
    '#expert .section-header p': { text: 'Latest cross-border tax and compliance analysis.' },
    ...
    '#policy .section-header p': {
      text: 'From tax authorities (CN, HK, US, UK, EU) and major platforms (Amazon, Walmart).',
    },
    '.policy-filter-group:nth-child(1) h3': { text: 'Region' },
    '.policy-filter-group:nth-child(2) h3': { text: 'Source' },
    '#regionChips .chip[data-region="all"]': { text: 'All' },
    '#regionChips .chip[data-region="cn"]': { text: 'Mainland China' },
    '#regionChips .chip[data-region="hk"]': { text: 'Hong Kong' },
    '#regionChips .chip[data-region="us"]': { text: 'United States' },
    '#regionChips .chip[data-region="uk"]': { text: 'United Kingdom' },
    '#regionChips .chip[data-region="eu"]': { text: 'European Union' },
    '#sourceChips .chip[data-source="all"]': { text: 'All' },
    '#sourceChips .chip[data-source="tax"]': { text: 'Tax authorities' },
    '#sourceChips .chip[data-source="platform"]': { text: 'Marketplaces' },
    '#loadMorePolicies': { text: 'Load more' },
    ...
    '.footer-links a[href="#expert"]': { text: 'Insights' },
    ...
    '.article-page .nav a[href="/#expert"]': { text: 'Insights' },
    ...
    '.footer-compact .footer-bottom a[href="/#expert"]': { text: 'More insights' },
  ...
  policies: [
    ...
    { title: '9610 retail export VAT exemption guide', summary: 'Pilot-zone firms with platform registration may qualify for 4% VAT exemption on eligible exports without invoices.' },
    ...
    { title: 'IRD: Profits tax filing and record keeping', summary: 'Hong Kong operators must maintain records and file within 4 months after year-end; late filing may incur penalties.' },
    ...
    { title: 'HMRC: Overseas sellers via UK marketplaces', summary: 'Non-UK sellers may have VAT handled by platforms; UK inventory may trigger separate registration.' },
    ...
    { title: 'Amazon: EU VAT registration in Seller Central', summary: 'EU selling requires VAT registration and valid tax IDs in Seller Central. Align stock location with tax settings.' },
    { title: 'Amazon: VAT calculation shifts to shipment level', summary: 'From June 2026, EU/UK VAT calculated per shipment rather than order — update ERP integrations accordingly.' },
    ...
    { title: 'Walmart: Marketplace facilitator addendum', summary: 'Defines collection scope and seller obligations. Review before expanding to new states.' },
  ],
  team: [
    {
