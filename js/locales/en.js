window.DAOITH_I18N_ZH = {
  ...
  strings: {
    ...
    'form.hsPlaceholder': '海关编码或商品名称关键词',
...
window.DAOITH_I18N_EN = {
  ...
  strings: {
    ...
    'alert.hsCode': 'Please enter an HS code or product name',
    ...
    'form.hsPlaceholder': 'HS code or product keyword',
  ...
  services: [
    ...
    { title: 'Malaysia · bookkeeping & tax', desc: 'Annual bookkeeping and tax filing by transaction volume.', detailBtn: 'Service details', cartBtn: 'Add to inquiry list', unit: ' / year from' },
    ...
    { title: 'Malaysia · one-off services', desc: 'Annual return, industry licences, tax advisory and incentives.', detailBtn: 'Service details', cartBtn: 'Add to inquiry list', unit: ' / year' },
    ...
    { title: 'Singapore · bookkeeping & tax', desc: 'Annual pack, standalone bookkeeping/XBRL, tax agent, statutory audit.', detailBtn: 'Service details', cartBtn: 'Add to inquiry list', unit: ' / year from' },
    ...
    { title: 'Singapore · one-off services', desc: 'GST registration, withholding tax / tax-resident certificate.', detailBtn: 'Service details', cartBtn: 'Add to inquiry list', unit: ' / filing' },
    { title: 'UK · company setup', desc: 'Company incorporation and VIP registered-address mail service.', detailBtn: 'Service details', cartBtn: 'Add to inquiry list', unit: '' },
    { title: 'UK · bookkeeping & tax', desc: 'Annual accounts & corporation tax, monthly bookkeeping, VAT returns.', detailBtn: 'Service details', cartBtn: 'Add to inquiry list', unit: ' / year from' },
    { title: 'UK · payroll tax', desc: 'PAYE and pension scheme filings per employee.', detailBtn: 'Service details', cartBtn: 'Add to inquiry list', unit: ' / person / month' },
    { title: 'UK · one-off services', desc: 'Annual return, VAT / EORI / PAYE / pension registration, UTR reset, strike-off, tax investigation cover.', detailBtn: 'Service details', cartBtn: 'Add to inquiry list', unit: ' / year' },
  ],
  servicesCatalog: [
    {
      id: 'consult-1v1',
