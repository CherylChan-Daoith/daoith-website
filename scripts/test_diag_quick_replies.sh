...
const cases = [
  ...
  { name: "step2-entity-with-shipping-echo", text: "好的，已记录发货方式为「全托管（国内仓）」。接下来第二步：您平台店铺的注册主体是中国个人、中国大陆公司、中国香港公司、外籍个人、其他境外公司？", mode: "diagnosis", step: 2, platform: "速卖通", expect: "entity" },
  ...
  { name: "step2-entity", text: "第二步：您平台店铺的注册主体是中国个人、中国大陆公司、中国香港公司、外籍个人、其他境外公司？", mode: "diagnosis", step: 2, platform: "速卖通", expect: "entity" },
